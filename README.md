...
**– Import Identity Provider Metadata dialog.**
...
**-ServiceNow landing page after SSO.**
...
– Identity Provider form.**Post troubleshooting-image**
...
**– Identity Providers list showing the Entra SAML IdP as Active.**
